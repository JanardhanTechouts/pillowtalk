...
<h2>Billing Address</h2>
      <form:form method = "POST" action = "placeorder">
         <table>
            ...
            <tr>
               <td><form:label path = "age">Address Line1 :</form:label></td>
               <td><form:input path = "age" /></td>
            </tr>
            <tr>
               <td><form:label path = "id">Address Line2 :</form:label></td>
               <td><form:input path = "id" /></td>
            </tr>
            <tr>
               <td><form:label path = "id">City : </form:label></td>
               <td><form:input path = "id" /></td>
            </tr>
            <tr>
               <td><form:label path = "id">State :</form:label></td>
               <td><form:input path = "id" /></td>
            </tr>
            <tr>
               <td colspan = "2">
